...
import { ExternalLink, Calendar, Tag, Compass, Flame, Heart, Eye, Clock } from 'lucide-react';
...
export default function MapComponent({
  ...
  return (
    <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border border-zinc-200 dark:border-zinc-800">
      ...
      <div className="absolute top-4 left-4 z-10 hidden sm:flex items-center gap-3 px-3.5 py-2 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md border border-zinc-200/80 dark:border-zinc-800 rounded-xl shadow-lg text-xs font-medium text-zinc-700 dark:text-zinc-300">
        <div className="flex items-center gap-1.5">
          <Compass className="w-4 h-4 text-blue-500" />
          <span>India Live Event Map</span>
        </div>
        <span className="bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full text-[10px] font-bold">
