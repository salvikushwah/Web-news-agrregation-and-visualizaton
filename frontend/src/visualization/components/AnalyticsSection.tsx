...
export default function AnalyticsSection({ events, isOpen, onClose }: AnalyticsSectionProps) {
  ...
  return (
    <div className="analytics-overlay fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 backdrop-blur-xl animate-in fade-in duration-200">
      <div className="analytics-modal relative w-full max-w-5xl max-h-[90vh] bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col">
        {/* Modal Header */}
